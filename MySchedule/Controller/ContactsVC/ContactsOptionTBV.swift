...
class ContactsOptionTBV: UITableViewController {
    ...
    private func setupView() {
        ...
        tableView.register(OptionTVC.self, forCellReuseIdentifier: idContcactsOptionCell)
        tableView.register(OptionHTC.self, forHeaderFooterViewReuseIdentifier: idContcactsOptionHeader)
    }
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: idContcactsOptionCell, for: indexPath) as! OptionTVC
    ...
    override func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        let header = tableView.dequeueReusableHeaderFooterView(withIdentifier: idContcactsOptionHeader) as! OptionHTC
...
extension ContactsOptionTBV: UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    func imagePickerController(_ picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [UIImagePickerController.InfoKey : Any]) {
        ...
        let cell = tableView.cellForRow(at: [4,0]) as! OptionTVC
